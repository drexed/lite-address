...
module Lite
  module Address
    # class US
    #
    #   # CARDINAL_CODES = YAML.load_file(
    #   #   File.expand_path('formats/cardinals.yml', File.dirname(__FILE__))
    #   # ).freeze
    #   # CODE_CARDINALS = CARDINAL_CODES.invert
    #   #
    #   # STREET_TYPES = YAML.load_file(
    #   #   File.expand_path('formats/streets.yml', File.dirname(__FILE__))
    #   # ).freeze
    #   # STREET_TYPES_LIST = {}
      ...
      class << self
        ...
        private
          ...
          def to_address(input, args)
            ...
            return Lite::Address::Details.new( input )
          end
      end
    end
